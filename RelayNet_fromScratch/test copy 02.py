...
# Define the ClassificationBlock
...
decoder = DecoderBlock(in_channels=17, out_channels=16)  # in_channels = 16 (encoded) + 1 (concat_features)
classifier = ClassificationBlock(in_channels=16, num_classes=9)  # Set to 9 classes
...
for images, labels in dataloader:
    ...
    # Show encoded and decoded images side by side
    show_encoded_decoded_images(encoded[:4], decoded[:4])
